export const config = {
    coupleNames: process.env.NEXT_PUBLIC_COUPLE_NAMES || "Ruth & Teofilus",
    ...
    brideNickName: process.env.NEXT_PUBLIC_BRIDE_NICKNAME || "Ruth",
    ...
    bibleVerse: process.env.NEXT_PUBLIC_BIBLE_VERSE || "1 Korintus 13:4-7",
